[assembly: WebActivator.PreApplicationStartMethod(typeof(MvcApplication1.App_Start.StorageServices), "PreStart")]

namespace MvcApplication1.App_Start
{
    using System.Web.Routing;
    using Microsoft.WindowsAzure;
    using MvcApplication1.CloudServices.Storage;
                ...
                c =>
                    {
                        ...
                        c.CloudStorageAccount = CloudStorageAccount.Parse("DefaultEndpointsProtocol=http;AccountName=wadeteched;AccountKey=7w/vqlNGftEOcOXA+p/CN2H3t13efTLHGNFYnhgFa38DXLCwJCV8j+uRJWxvRJ5hv5EgYYeYozhnL7aDQNVuTg==");
